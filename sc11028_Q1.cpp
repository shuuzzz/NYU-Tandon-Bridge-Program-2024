...
int printMonthCal(int numOfDays, int startingDay);
...
void printYearCalender(int year, int startingDay) {
    ...
    startingDay = printMonthCal(31, startingDay) + 1;
    cout << endl;

    cout << "February " << year << endl;
    startingDay = printMonthCal(getNumOfDaysInFeb(year), startingDay) + 1;
    cout << endl;
    ...
    startingDay = printMonthCal(30, startingDay) + 1;
    cout << endl;
